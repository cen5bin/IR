...
#define INVERTED_INDEX_FILE IR_RUNTIME_DATA"inverted_index.dat" //倒排索引文件

#define PRE_INDEX_TMP_FILE IR_RUNTIME_TMP"pre_index.tmp"
#define PRE_INDEX_FILE IR_RUNTIME_DATA"pre_index.dat"

//#define DICT_PATH IR_RUNTIME_DATA"dict/" //词典路径
#define DICT_TMP_FILE IR_RUNTIME_TMP"dict.tmp" //词典文件名 临时
#define DICT_FILE IR_RUNTIME_DATA"dict.txt" //词典文件名 正式


#define SPORTS_DOC_PATH DATA_PATH"sport/" //体育新闻文档路径

#define STATISTIC_FILE_PATH DATA_PATH"statistic.dat" //系统数据的统计信息
